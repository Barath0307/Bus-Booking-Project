                                    ...
                                    <div className="col-md-6">
                                        <form className="form" onSubmit={e => onSubmit(e)}>
                                            <div className="form-group2">
                                                ...
                                                <input type="text" placeholder="Ex:- Barath" name="name" value={name} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required name="email" placeholder="Ex:- barath@gmail.com" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                            ...
                                            <div className="form-group2">
                                                ...
                                                <input required id="password" name="password" value={password} placeholder="Ex:-barath@1234" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="password">Re-Password :</label>
                                                <input required id="password2" name="password2" value={password2} placeholder="Ex:-barath@1234" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
