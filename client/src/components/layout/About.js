        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center">
            <div className="col-md-12 text-center">
              <h1><strong>Welcome to BarathVerse Bus Travels</strong></h1>
              <p>
        ...
        <div className="container text-center">
          ...
          <div className="container">
            ...
            <div className="col-md-12">
              <p>https://www.facebook.com/barathverse</p>

              <p>https://www.instagram.com/barathverse</p>

              <p>https://www.google.com/barathverse</p>

              <p>https://www.twitter.com/barathverse</p>
